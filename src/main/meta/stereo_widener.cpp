...
#define LSP_PLUGINS_STEREO_WIDENER_VERSION_MAJOR       1
#define LSP_PLUGINS_STEREO_WIDENER_VERSION_MINOR       0
#define LSP_PLUGINS_STEREO_WIDENER_VERSION_MICRO       0

#define LSP_PLUGINS_STEREO_WIDENER_VERSION  \
    LSP_MODULE_VERSION( \
        LSP_PLUGINS_STEREO_WIDENER_VERSION_MAJOR, \
        LSP_PLUGINS_STEREO_WIDENER_VERSION_MINOR, \
        LSP_PLUGINS_STEREO_WIDENER_VERSION_MICRO  \
    )
...
namespace lsp
{
    namespace meta
    {
        ...
        static const port_t stereo_widener_mono_ports[] =
        {
            ...
            // Input controls
            BYPASS,
            INT_CONTROL("d_in", "Delay in samples", U_SAMPLES, stereo_widener::SAMPLES),
            DRY_GAIN(0.0f),
            WET_GAIN(1.0f),
            OUT_GAIN,

            // Output controls
            METER_MINMAX("d_out", "Delay time in milliseconds", U_MSEC, 0.0f, stereo_widener::DELAY_OUT_MAX_TIME),
        ...
        // NOTE: Port identifiers should not be longer than 7 characters as it will overflow VST2 parameter name buffers
        static const port_t stereo_widener_stereo_ports[] =
        {
            // Input and output audio ports
            PORTS_STEREO_PLUGIN,
        ...
        const meta::bundle_t stereo_widener_bundle =
        {
            "stereo_widener",
            "Plugin Template",
            B_UTILITIES,
        ...
        const plugin_t stereo_widener_mono =
        {
            ...
            "stereo_widener_mono",
            LSP_LV2_URI("stereo_widener_mono"),
            LSP_LV2UI_URI("stereo_widener_mono"),
            "xxxx",         // TODO: fill valid VST2 ID (4 letters/digits)
            1,              // TODO: fill valid LADSPA identifier (positive decimal integer)
            LSP_LADSPA_URI("stereo_widener_mono"),
            LSP_CLAP_URI("stereo_widener_mono"),
            LSP_PLUGINS_STEREO_WIDENER_VERSION,
            plugin_classes,
            clap_features_mono,
            E_DUMP_STATE,
            stereo_widener_mono_ports,
            "template/plugin.xml",
            NULL,
            mono_plugin_port_groups,
            &stereo_widener_bundle
        };
        ...
        const plugin_t stereo_widener_stereo =
        {
            ...
            "PS1S",
            &developers::v_sadovnikov,
            "stereo_widener_stereo",
            LSP_LV2_URI("stereo_widener_stereo"),
            LSP_LV2UI_URI("stereo_widener_stereo"),
            "yyyy",         // TODO: fill valid VST2 ID (4 letters/digits)
            2,              // TODO: fill valid LADSPA identifier (positive decimal integer)
            LSP_LADSPA_URI("stereo_widener_stereo"),
            LSP_CLAP_URI("stereo_widener_stereo"),
            LSP_PLUGINS_STEREO_WIDENER_VERSION,
            plugin_classes,
            clap_features_stereo,
            E_DUMP_STATE,
            stereo_widener_stereo_ports,
            "template/plugin.xml",
            NULL,
